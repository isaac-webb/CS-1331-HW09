...
/**
  * A factory that creates a list of Pokemon
  *
...
public final class PokemonFactory {
    ...
    public static ArrayList<Pokemon> createPokemon() {
        ...
        charmander.setDescription("Obviously prefers hot places. When it "
                                  + "rains, steam is said to spout from the "
                                  + "tip of its tail.");
        ...
        pikachu.setDescription("Whenever Pikachu comes across something new, "
                               + "it blasts it with a jolt of electricity. If "
                               + "you come across a blackened berry, it's "
                               + "evidence that this Pokémon mistook the"
        ...
        abra.setDescription("Abra sleeps for eighteen hours a day. However,"
                            + " it can sense the presence of foes even while it"
                            + " is sleeping. In such a situation, this Pokémon "
